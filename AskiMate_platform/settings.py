...
# میان‌افزارها (middleware) – اضافه کردن whitenoise
MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',
    'whitenoise.middleware.WhiteNoiseMiddleware',  # <-- اضافه شده برای static
...
# Static files
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # اینجا فایل‌ها با collectstatic ریخته می‌شن
